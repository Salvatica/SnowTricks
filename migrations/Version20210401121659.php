 ...
 */
final class Version20210401121659 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD created_at DATETIME NOT NULL, ADD update_date DATETIME NOT NULL, DROP user_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE figure ADD user_id INT NOT NULL, DROP created_at, DROP update_date');
